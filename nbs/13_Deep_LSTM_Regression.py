...
configs = [
#        {"name": "lstm32d_2fc128n", "lstm_dim": 32, "ret_seq": False},
#        {"name": "lstm64d_2fc128n", "lstm_dim": 64, "ret_seq": False},
#        {"name": "lstm128d_2fc128n", "lstm_dim": 128, "ret_seq": False},
        {"name": "lstm32dseq_2fc128n", "lstm_dim": 32, "ret_seq": True},
        {"name": "lstm64dseq_2fc128n", "lstm_dim": 64, "ret_seq": True},
        {"name": "lstm128dseq_2fc128n", "lstm_dim": 128, "ret_seq": True},
]
...
from tep.deepLSTMModel import regression_model
